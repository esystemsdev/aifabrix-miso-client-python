...
def load_config() -> MisoClientConfig:
    ...
    - MISO_ENCRYPTION_KEY or ENCRYPTION_KEY (encryption key for encrypt/decrypt operations)
    ...
    # Optional encryption key for security parameter operations (support both env names)
